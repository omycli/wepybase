...
/***** module 0 start *****/
/***** node_modules/wepy-web/lib/platform/wechat.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';

exports.__esModule = true;

var _util = __wepy_require(15);

var _query = __wepy_require(16);
...
/***** module 1 start *****/
/***** src/pages/testIndex.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"container column-center\">\n        <div class=\"icon-cherry1\"></div>\n        <div @click=\"move($event)\" :class=\"'icon-cherry2 animated ' + (moveR ? 'bounceOutRight' : '')\"></div>\n        <open-data class=\"logo\" type=\"userAvatarUrl\" lang=\"zh_CN\"></open-data>\n        <div class=\"column-center\">\n            <div class=\"card column-center\" @click=\"pay($event)\">\n                支付\n            </div>\n        </div>\n        <div class=\"content \">\n            <div class=\"hd\" :style=\"'transform:rotateZ(' + (angle) + 'deg);'\">\n                <img class=\"wave\" mode=\"aspectFill\" src=\"/images/wave.png\"/>\n                <img class=\"wave wave-bg\" mode=\"aspectFill\" src=\"/images/wave.png\"/>\n            </div>\n            <div class=\"bd\">\n                <div @click=\"rich($event)\" class=\"btn\" hover-class=\"btn-hover\">跳转富文本</div>\n                <div @click=\"swiper($event)\" class=\"btn\" hover-class=\"btn-hover\">swiper</div>\n            </div>\n        </div>\n    </div>\n"},/***** module 1 end *****/


/***** module 2 start *****/
/***** src/pages/pays.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"page-pays\">\n        <div v-if=\"(title)\">支付信息：{{title}}</div>\n        <div v-if=\"(amount)\">支付金额：{{amount}}</div>\n        <div v-if=\"(jumpUrl)\">支付成功跳转页面：{{jumpUrl}}</div>\n    </div>\n"},/***** module 2 end *****/


/***** module 3 start *****/
/***** src/pages/web.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <web-view :src=\"(res)\" src=\"{{res}}\"></web-view>\n"},/***** module 3 end *****/


/***** module 4 start *****/
/***** src/pages/swiper.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n    <div class=\"swiper-demo\">\n        <swiper @change=\"onSwiperChange($event)\" style=\"overflow: visible;\" circular=\"true\" duration=\"300\" interval=\"5000\" :current=\"( curIndex )\" :indicator-dots=\"(indicatorDots)\" :autoplay=\"(autoplay)\">\n            <div key=\"actpic\" v-for=\"(index, item) in ( imgUrls )\">\n                <swiper-item style=\"overflow: visible;\">\n                    <img mode=\"aspectFill\" :src=\"( item )\" :style=\"'-webkit-transform: scale(' + ( curIndex == index ? 0.9 : 0.65 ) + ') translate(' + ( (curIndex == index - 1 || curIndex == index + 1) ? (curIndex - index) * 30 : 0 ) + '%, 0);'\"/>\n                </swiper-item>\n            </div>\n        </swiper>\n    </div>\n"},/***** module 4 end *****/
...
var _class = function (_wepy$app) {
    ...
    function _class() {
        ...
        _this.config = {
            pages: ['pages/testIndex', 'pages/pays', 'pages/web', 'pages/swiper'],
            window: {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 9:
                                this.globalData.token = _context.sent;
        ...
        value: function login() {
            ...
            return new Promise(function (resolve, reject) {
                _wepy2.default.login().then(function (res) {
                    if (res.code) {
                        _this2.globalData.code = res.code;
                        if (_this2.globalData.IS_DEV) {
...
__wepy_require(6).default.$createApp(_class, {"routes":{"pages/testIndex":9,"pages/pays":10,"pages/web":13,"pages/swiper":14},"style":[38,39,40,41],"components":{},"apis":{}}, {});
...
var _app = __wepy_require(17);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(18);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(19);

var _component2 = _interopRequireDefault(_component);

var _event = __wepy_require(20);

var _event2 = _interopRequireDefault(_event);

var _base = __wepy_require(21);

var _base2 = _interopRequireDefault(_base);

var _util = __wepy_require(22);

var _util2 = _interopRequireDefault(_util);

var _mixin = __wepy_require(23);

var _mixin2 = _interopRequireDefault(_mixin);

var _wx = __wepy_require(24);
...
// 测试环境和生产环境，发布改成false
var IS_DEV_URL = false;

var BaseUrl = exports.BaseUrl = IS_DEV_URL === true ? 'https://tshttps.com' : 'https://https.com';
},/***** module 7 end *****/
...
var g = __wepy_require(25);

if (!g.Promise) {
  // IOS 10.0.1 may cause IOS crash.
  g.Promise = __wepy_require(26);
}
if (!g.regeneratorRuntime) {
  g.regeneratorRuntime = __wepy_require(27);
}
...
var testIndex = function (_wepy$page) {
    _inherits(testIndex, _wepy$page);
    ...
    function testIndex() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = testIndex.__proto__ || Object.getPrototypeOf(testIndex)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
...
var _index = __wepy_require(11);

var _index2 = _interopRequireDefault(_index);

var _Tips = __wepy_require(12);
...
var pays = function (_wepy$page) {
    _inherits(pays, _wepy$page);
    ...
    function pays() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = pays.__proto__ || Object.getPrototypeOf(pays)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _Tips2.default.loading('支付中');
                                _context3.next = 6;
                                return _index2.default.payMoney();
...
var _base2 = __wepy_require(28);

var _base3 = _interopRequireDefault(_base2);

var _index = __wepy_require(29);
    ...
    _createClass(api, null, [{
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                if (!_wepy2.default.$instance.globalData.IS_DEV) {
                                    _context.next = 6;
                                    break;
                                }
                                ...
                                return setTimeout(function () {
                                    _this2.ajaxdata = _index2.default;
                                });
                            ...
                            case 8:
                                this.ajaxdata = _context.sent;

                            case 9:
                                indexData = this.ajaxdata;
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                var code, url, ajaxData, payData;
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                code = _wepy2.default.$instance.globalData.code;
                                ...
                                url = this.baseUrl + '/test/get_pay';
                                ajaxData = {
                                    code: code
                                };
                                _context2.next = 6;
                                return this.get(url, ajaxData);

                            case 6:
                                payData = _context2.sent;
...
var swiper = function (_wepy$page) {
    ...
    function swiper() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = swiper.__proto__ || Object.getPrototypeOf(swiper)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
            ...
            imgUrls: ['http://bmob-cdn-14867.b0.upaiyun.com/2017/12/01/89a6eba340008dce801381c4550787e4.png', 'http://bmob-cdn-14867.b0.upaiyun.com/2017/12/01/89a6eba340008dce801381c4550787e4.png', 'http://bmob-cdn-14867.b0.upaiyun.com/2017/12/01/89a6eba340008dce801381c4550787e4.png', 'http://bmob-cdn-14867.b0.upaiyun.com/2017/12/01/89a6eba340008dce801381c4550787e4.png', 'http://bmob-cdn-14867.b0.upaiyun.com/2018/03/14/95904de0409bda1d80c782d50f6e89b0.jpg', 'http://img06.tooopen.com/images/20160818/tooopen_sy_175833047715.jpg'],
            indicatorDots: true,
            autoplay: false,
            curIndex: 0
        }, _this.methods = {
...
/***** module 15 start *****/
/***** node_modules/wepy-web/lib/helper/util.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
var _component2 = __wepy_require(19);
...
var http = function () {
    ...
    _createClass(http, null, [{
         ...
         * 通过参数获取lockkey，唯一值
         */
        value: function getLockey(string) {
            if (string) {
                //有option对象，把它变成字符串
                string = encodeURI(string);
                var md5 = _MD2.default.hexMD5(string);
                return md5;
            }
        }
    }, {
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(method, url, data) {
                var lockKey, header, param, res;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return this.getLockey(JSON.stringify(url));

                            case 2:
                                lockKey = _context.sent;
...
/***** module 38 start *****/
/***** src/app.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "@charset \"UTF-8\";\n/**\n * 样式主文件\n */\n.container {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex: 1;\n  background: #69c3aa;\n  align-items: stretch;\n  padding: 0;\n  height: 100%;\n  overflow: hidden;\n  box-sizing: border-box;\n}\n\n@keyframes rise {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, 100%, 0);\n  }\n  50% {\n    opacity: 1;\n  }\n  100% {\n    opacity: 1;\n    transform: translate3d(0, 225px, 0);\n  }\n}\n\n@keyframes wave {\n  from {\n    transform: translate3d(62.5px, 0, 0);\n  }\n  to {\n    transform: translate3d(562.5px, 0, 0);\n  }\n}\n\n@keyframes wave-bg {\n  from {\n    transform: translate3d(187.5px, 0, 0);\n  }\n  to {\n    transform: translate3d(687.5px, 0, 0);\n  }\n}\n\n@keyframes bd-rise {\n  from {\n    opacity: 0;\n    transform: translate3d(0, 30px, 0);\n  }\n  to {\n    opacity: 1;\n    transform: translate3d(0, 0, 0);\n  }\n}\n\n.btn-hover {\n  opacity: 0.8;\n}\n\n/**\n * 常用的 mixins\n */\n/**\n   * 文本截断 - text ellipsis\n   * @param  {integer} $num [文本截断的行数]\n   */\n/**\n   * 清除浮动\n   */\n/**\n   * 隐藏滚动条\n   */\n/**\n   * 1像素边框\n   * @param  {string} $position [边框位置，取值：top, bottom, left, right, full]\n   * @param  {string} $borderColor [边框颜色]\n   * @param  {number} $raidus [圆角]\n   *\n   * 例子：\n   *   @include border(top, #ddd);\n   *   @include border(full, #ddd, 2px);\n   */\n/**\n  * 页面的基础样式，包括样式重置\n  */\nbody {\n  width: 100%;\n  height: 100%;\n  margin: 0;\n  overflow: hidden;\n  font-family: -apple-system, Helvetica, 'Microsoft YaHei', Arial, sans-serif;\n}\n\n.mr10 {\n  margin-right: 5px;\n}\n\n.mr20 {\n  margin-right: 10px;\n}\n\n.ml10 {\n  margin-left: 5px;\n}\n\n.ml20 {\n  margin-left: 10px;\n}\n\n.ml40 {\n  margin-left: 20px;\n}\n\n.ml120 {\n  margin-left: 60px;\n}\n\n.mt10 {\n  margin-top: 5px;\n}\n\n.mt20 {\n  margin-top: 10px;\n}\n\n.mb10 {\n  margin-bottom: 5px;\n}\n\n.mb20 {\n  margin-bottom: 10px;\n}\n\n.pdlr20 {\n  padding: 0 10px;\n}\n\n.r80 {\n  right: 40px;\n}\n\n.r40 {\n  right: 20px;\n}\n\ncheckbox .wx-checkbox-input {\n  width: 17px;\n  height: 17px;\n}\n\ncheckbox .wx-checkbox-input.wx-checkbox-input-checked {\n  background-color: #ffde0e;\n}\n\nradio .wx-radio-input {\n  width: 17px;\n  height: 17px;\n}\n\nradio .wx-radio-input.wx-radio-input-checked {\n  background-color: #ffde0e;\n}\n\nbutton {\n  background-color: #999999;\n}\n\nbutton[type=\"primary\"] {\n  background-color: #1296DB;\n}\n\n.button-hover[type=\"primary\"] {\n  background-color: #1296DB;\n}\n\n.row, .row-center, .row-between, .row-around, .row-end {\n  display: flex;\n  display: -webkit-flex;\n  flex-direction: row;\n  -webkit-flex-direction: row;\n  align-items: center;\n  -webkit-align-items: center;\n}\n\n.row-center {\n  justify-content: center;\n  -webkit-justify-content: center;\n}\n\n.row-between {\n  justify-content: space-between;\n  -webkit-justify-content: space-between;\n}\n\n.row-around {\n  justify-content: space-around;\n  -webkit-justify-content: space-around;\n}\n\n.row-end {\n  justify-content: flex-end;\n  -webkit-justify-content: flex-end;\n}\n\n.column, .column-center, .column-around, .column-between {\n  display: flex;\n  display: -webkit-flex;\n  justify-content: center;\n  -webkit-justify-content: center;\n  flex-direction: column;\n  -webkit-flex-direction: column;\n}\n\n.column-center {\n  align-items: center;\n  -webkit-align-items: center;\n}\n\n.column-around {\n  align-items: center;\n  -webkit-align-items: center;\n  justify-content: space-around;\n  -webkit-justify-content: space-around;\n}\n\n.column-between {\n  align-items: center;\n  -webkit-align-items: center;\n  justify-content: space-between;\n  -webkit-justify-content: space-between;\n}\n\n.row-wrap {\n  flex-wrap: wrap;\n  -webkit-flex-wrap: wrap;\n}\n\n.row-nowrap {\n  flex-wrap: nowrap;\n  -webkit-flex-wrap: nowrap;\n}\n\n.fixed-bottom {\n  position: fixed;\n  bottom: 0;\n}\n\n.icon {\n  height: 20px;\n  width: 20px;\n  vertical-align: middle;\n  -webkit-vertical-align: middle;\n}\n\n.icon-lg {\n  height: 30px;\n  width: 30px;\n  vertical-align: middle;\n  -webkit-vertical-align: middle;\n}\n\n.icon-xl {\n  height: 50px;\n  width: 50px;\n  vertical-align: middle;\n  -webkit-vertical-align: middle;\n}\n\n.icon-xxl {\n  height: 60px;\n  width: 60px;\n  vertical-align: middle;\n  -webkit-vertical-align: middle;\n}\n\n.icon-round {\n  border-radius: 50%;\n}\n\n.hr {\n  width: 100%;\n  height: 3px;\n}\n\n.h-gap {\n  width: 100%;\n  height: 14px;\n}\n\n.br {\n  width: 10px;\n  height: 3px;\n}\n\n.hidden {\n  display: none;\n}\n\n/*\nIcon classes can be used entirely standalone. They are named after their original file names.\n\nExample usage in HTML:\n\n`display: block` sprite:\n<div class=\"icon-home\"></div>\n\nTo change `display` (e.g. `display: inline-block;`), we suggest using a common CSS class:\n\n// CSS\n.icon {\n  display: inline-block;\n}\n\n// HTML\n<i class=\"icon icon-home\"></i>\n*/\n.icon-cherry1 {\n  background-image: url(data:image/png;base64,);\n  background-position: -69px 0px;\n  width: 31px;\n  height: 31px;\n}\n\n.icon-cherry2 {\n  background-image: url(data:image/png;base64,);\n  background-position: 0px 0px;\n  width: 69px;\n  height: 66px;\n}\n\n.animated {\n  animation-duration: 1s;\n  animation-fill-mode: both;\n}\n\n.animated.infinite {\n  animation-iteration-count: infinite;\n}\n\n.animated.hinge {\n  animation-duration: 2s;\n}\n\n.animated.bounceIn, .animated.bounceOut, .animated.flipOutX, .animated.flipOutY {\n  animation-duration: .75s;\n}\n\n@keyframes bounce {\n  0%, 20%, 53%, 80%, to {\n    animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n    transform: translateZ(0);\n  }\n  40%, 43% {\n    animation-timing-function: cubic-bezier(0.755, 0.05, 0.855, 0.06);\n    transform: translate3d(0, -30px, 0);\n  }\n  70% {\n    animation-timing-function: cubic-bezier(0.755, 0.05, 0.855, 0.06);\n    transform: translate3d(0, -15px, 0);\n  }\n  90% {\n    transform: translate3d(0, -4px, 0);\n  }\n}\n\n.bounce {\n  animation-name: bounce;\n  transform-origin: center bottom;\n}\n\n@keyframes flash {\n  0%, 50%, to {\n    opacity: 1;\n  }\n  25%, 75% {\n    opacity: 0;\n  }\n}\n\n.flash {\n  animation-name: flash;\n}\n\n@keyframes pulse {\n  0% {\n    transform: scaleX(1);\n  }\n  50% {\n    transform: scale3d(1.05, 1.05, 1.05);\n  }\n  to {\n    transform: scaleX(1);\n  }\n}\n\n.pulse {\n  animation-name: pulse;\n}\n\n@keyframes rubberBand {\n  0% {\n    transform: scaleX(1);\n  }\n  30% {\n    transform: scale3d(1.25, 0.75, 1);\n  }\n  40% {\n    transform: scale3d(0.75, 1.25, 1);\n  }\n  50% {\n    transform: scale3d(1.15, 0.85, 1);\n  }\n  65% {\n    transform: scale3d(0.95, 1.05, 1);\n  }\n  75% {\n    transform: scale3d(1.05, 0.95, 1);\n  }\n  to {\n    transform: scaleX(1);\n  }\n}\n\n.rubberBand {\n  animation-name: rubberBand;\n}\n\n@keyframes shake {\n  0%, to {\n    transform: translateZ(0);\n  }\n  10%, 30%, 50%, 70%, 90% {\n    transform: translate3d(-10px, 0, 0);\n  }\n  20%, 40%, 60%, 80% {\n    transform: translate3d(10px, 0, 0);\n  }\n}\n\n.shake {\n  animation-name: shake;\n}\n\n@keyframes headShake {\n  0% {\n    transform: translateX(0);\n  }\n  6.5% {\n    transform: translateX(-6px) rotateY(-9deg);\n  }\n  18.5% {\n    transform: translateX(5px) rotateY(7deg);\n  }\n  31.5% {\n    transform: translateX(-3px) rotateY(-5deg);\n  }\n  43.5% {\n    transform: translateX(2px) rotateY(3deg);\n  }\n  50% {\n    transform: translateX(0);\n  }\n}\n\n.headShake {\n  animation-timing-function: ease-in-out;\n  animation-name: headShake;\n}\n\n@keyframes swing {\n  20% {\n    transform: rotate(15deg);\n  }\n  40% {\n    transform: rotate(-10deg);\n  }\n  60% {\n    transform: rotate(5deg);\n  }\n  80% {\n    transform: rotate(-5deg);\n  }\n  to {\n    transform: rotate(0deg);\n  }\n}\n\n.swing {\n  transform-origin: top center;\n  animation-name: swing;\n}\n\n@keyframes tada {\n  0% {\n    transform: scaleX(1);\n  }\n  10%, 20% {\n    transform: scale3d(0.9, 0.9, 0.9) rotate(-3deg);\n  }\n  30%, 50%, 70%, 90% {\n    transform: scale3d(1.1, 1.1, 1.1) rotate(3deg);\n  }\n  40%, 60%, 80% {\n    transform: scale3d(1.1, 1.1, 1.1) rotate(-3deg);\n  }\n  to {\n    transform: scaleX(1);\n  }\n}\n\n.tada {\n  animation-name: tada;\n}\n\n@keyframes wobble {\n  0% {\n    transform: none;\n  }\n  15% {\n    transform: translate3d(-25%, 0, 0) rotate(-5deg);\n  }\n  30% {\n    transform: translate3d(20%, 0, 0) rotate(3deg);\n  }\n  45% {\n    transform: translate3d(-15%, 0, 0) rotate(-3deg);\n  }\n  60% {\n    transform: translate3d(10%, 0, 0) rotate(2deg);\n  }\n  75% {\n    transform: translate3d(-5%, 0, 0) rotate(-1deg);\n  }\n  to {\n    transform: none;\n  }\n}\n\n.wobble {\n  animation-name: wobble;\n}\n\n@keyframes jello {\n  0%, 11.1%, to {\n    transform: none;\n  }\n  22.2% {\n    transform: skewX(-12.5deg) skewY(-12.5deg);\n  }\n  33.3% {\n    transform: skewX(6.25deg) skewY(6.25deg);\n  }\n  44.4% {\n    transform: skewX(-3.125deg) skewY(-3.125deg);\n  }\n  55.5% {\n    transform: skewX(1.5625deg) skewY(1.5625deg);\n  }\n  66.6% {\n    transform: skewX(-0.78125deg) skewY(-0.78125deg);\n  }\n  77.7% {\n    transform: skewX(0.39062deg) skewY(0.39062deg);\n  }\n  88.8% {\n    transform: skewX(-0.19531deg) skewY(-0.19531deg);\n  }\n}\n\n.jello {\n  animation-name: jello;\n  transform-origin: center;\n}\n\n@keyframes bounceIn {\n  0%, 20%, 40%, 60%, 80%, to {\n    animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  0% {\n    opacity: 0;\n    transform: scale3d(0.3, 0.3, 0.3);\n  }\n  20% {\n    transform: scale3d(1.1, 1.1, 1.1);\n  }\n  40% {\n    transform: scale3d(0.9, 0.9, 0.9);\n  }\n  60% {\n    opacity: 1;\n    transform: scale3d(1.03, 1.03, 1.03);\n  }\n  80% {\n    transform: scale3d(0.97, 0.97, 0.97);\n  }\n  to {\n    opacity: 1;\n    transform: scaleX(1);\n  }\n}\n\n.bounceIn {\n  animation-name: bounceIn;\n}\n\n@keyframes bounceInDown {\n  0%, 60%, 75%, 90%, to {\n    animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  0% {\n    opacity: 0;\n    transform: translate3d(0, -3000px, 0);\n  }\n  60% {\n    opacity: 1;\n    transform: translate3d(0, 25px, 0);\n  }\n  75% {\n    transform: translate3d(0, -10px, 0);\n  }\n  90% {\n    transform: translate3d(0, 5px, 0);\n  }\n  to {\n    transform: none;\n  }\n}\n\n.bounceInDown {\n  animation-name: bounceInDown;\n}\n\n@keyframes bounceInLeft {\n  0%, 60%, 75%, 90%, to {\n    animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  0% {\n    opacity: 0;\n    transform: translate3d(-3000px, 0, 0);\n  }\n  60% {\n    opacity: 1;\n    transform: translate3d(25px, 0, 0);\n  }\n  75% {\n    transform: translate3d(-10px, 0, 0);\n  }\n  90% {\n    transform: translate3d(5px, 0, 0);\n  }\n  to {\n    transform: none;\n  }\n}\n\n.bounceInLeft {\n  animation-name: bounceInLeft;\n}\n\n@keyframes bounceInRight {\n  0%, 60%, 75%, 90%, to {\n    animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  0% {\n    opacity: 0;\n    transform: translate3d(3000px, 0, 0);\n  }\n  60% {\n    opacity: 1;\n    transform: translate3d(-25px, 0, 0);\n  }\n  75% {\n    transform: translate3d(10px, 0, 0);\n  }\n  90% {\n    transform: translate3d(-5px, 0, 0);\n  }\n  to {\n    transform: none;\n  }\n}\n\n.bounceInRight {\n  animation-name: bounceInRight;\n}\n\n@keyframes bounceInUp {\n  0%, 60%, 75%, 90%, to {\n    animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  0% {\n    opacity: 0;\n    transform: translate3d(0, 3000px, 0);\n  }\n  60% {\n    opacity: 1;\n    transform: translate3d(0, -20px, 0);\n  }\n  75% {\n    transform: translate3d(0, 10px, 0);\n  }\n  90% {\n    transform: translate3d(0, -5px, 0);\n  }\n  to {\n    transform: translateZ(0);\n  }\n}\n\n.bounceInUp {\n  animation-name: bounceInUp;\n}\n\n@keyframes bounceOut {\n  20% {\n    transform: scale3d(0.9, 0.9, 0.9);\n  }\n  50%, 55% {\n    opacity: 1;\n    transform: scale3d(1.1, 1.1, 1.1);\n  }\n  to {\n    opacity: 0;\n    transform: scale3d(0.3, 0.3, 0.3);\n  }\n}\n\n.bounceOut {\n  animation-name: bounceOut;\n}\n\n@keyframes bounceOutDown {\n  20% {\n    transform: translate3d(0, 10px, 0);\n  }\n  40%, 45% {\n    opacity: 1;\n    transform: translate3d(0, -20px, 0);\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(0, 2000px, 0);\n  }\n}\n\n.bounceOutDown {\n  animation-name: bounceOutDown;\n}\n\n@keyframes bounceOutLeft {\n  20% {\n    opacity: 1;\n    transform: translate3d(20px, 0, 0);\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(-2000px, 0, 0);\n  }\n}\n\n.bounceOutLeft {\n  animation-name: bounceOutLeft;\n}\n\n@keyframes bounceOutRight {\n  20% {\n    opacity: 1;\n    transform: translate3d(-20px, 0, 0);\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(2000px, 0, 0);\n  }\n}\n\n.bounceOutRight {\n  animation-name: bounceOutRight;\n}\n\n@keyframes bounceOutUp {\n  20% {\n    transform: translate3d(0, -10px, 0);\n  }\n  40%, 45% {\n    opacity: 1;\n    transform: translate3d(0, 20px, 0);\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(0, -2000px, 0);\n  }\n}\n\n.bounceOutUp {\n  animation-name: bounceOutUp;\n}\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n\n.fadeIn {\n  animation-name: fadeIn;\n}\n\n@keyframes fadeInDown {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, -100%, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInDown {\n  animation-name: fadeInDown;\n}\n\n@keyframes fadeInDownBig {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, -2000px, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInDownBig {\n  animation-name: fadeInDownBig;\n}\n\n@keyframes fadeInLeft {\n  0% {\n    opacity: 0;\n    transform: translate3d(-100%, 0, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInLeft {\n  animation-name: fadeInLeft;\n}\n\n@keyframes fadeInLeftBig {\n  0% {\n    opacity: 0;\n    transform: translate3d(-2000px, 0, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInLeftBig {\n  animation-name: fadeInLeftBig;\n}\n\n@keyframes fadeInRight {\n  0% {\n    opacity: 0;\n    transform: translate3d(100%, 0, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInRight {\n  animation-name: fadeInRight;\n}\n\n@keyframes fadeInRightBig {\n  0% {\n    opacity: 0;\n    transform: translate3d(2000px, 0, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInRightBig {\n  animation-name: fadeInRightBig;\n}\n\n@keyframes fadeInUp {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, 100%, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInUp {\n  animation-name: fadeInUp;\n}\n\n@keyframes fadeInUpBig {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, 2000px, 0);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.fadeInUpBig {\n  animation-name: fadeInUpBig;\n}\n\n@keyframes fadeOut {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n  }\n}\n\n.fadeOut {\n  animation-name: fadeOut;\n}\n\n@keyframes fadeOutDown {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(0, 100%, 0);\n  }\n}\n\n.fadeOutDown {\n  animation-name: fadeOutDown;\n}\n\n@keyframes fadeOutDownBig {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(0, 2000px, 0);\n  }\n}\n\n.fadeOutDownBig {\n  animation-name: fadeOutDownBig;\n}\n\n@keyframes fadeOutLeft {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(-100%, 0, 0);\n  }\n}\n\n.fadeOutLeft {\n  animation-name: fadeOutLeft;\n}\n\n@keyframes fadeOutLeftBig {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(-2000px, 0, 0);\n  }\n}\n\n.fadeOutLeftBig {\n  animation-name: fadeOutLeftBig;\n}\n\n@keyframes fadeOutRight {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(100%, 0, 0);\n  }\n}\n\n.fadeOutRight {\n  animation-name: fadeOutRight;\n}\n\n@keyframes fadeOutRightBig {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(2000px, 0, 0);\n  }\n}\n\n.fadeOutRightBig {\n  animation-name: fadeOutRightBig;\n}\n\n@keyframes fadeOutUp {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(0, -100%, 0);\n  }\n}\n\n.fadeOutUp {\n  animation-name: fadeOutUp;\n}\n\n@keyframes fadeOutUpBig {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(0, -2000px, 0);\n  }\n}\n\n.fadeOutUpBig {\n  animation-name: fadeOutUpBig;\n}\n\n@keyframes flip {\n  0% {\n    transform: perspective(400px) rotateY(-1turn);\n    animation-timing-function: ease-out;\n  }\n  40% {\n    transform: perspective(400px) translateZ(150px) rotateY(-190deg);\n    animation-timing-function: ease-out;\n  }\n  50% {\n    transform: perspective(400px) translateZ(150px) rotateY(-170deg);\n    animation-timing-function: ease-in;\n  }\n  80% {\n    transform: perspective(400px) scale3d(0.95, 0.95, 0.95);\n    animation-timing-function: ease-in;\n  }\n  to {\n    transform: perspective(400px);\n    animation-timing-function: ease-in;\n  }\n}\n\n.animated.flip {\n  -webkit-backface-visibility: visible;\n  backface-visibility: visible;\n  animation-name: flip;\n}\n\n@keyframes flipInX {\n  0% {\n    transform: perspective(400px) rotateX(90deg);\n    animation-timing-function: ease-in;\n    opacity: 0;\n  }\n  40% {\n    transform: perspective(400px) rotateX(-20deg);\n    animation-timing-function: ease-in;\n  }\n  60% {\n    transform: perspective(400px) rotateX(10deg);\n    opacity: 1;\n  }\n  80% {\n    transform: perspective(400px) rotateX(-5deg);\n  }\n  to {\n    transform: perspective(400px);\n  }\n}\n\n.flipInX {\n  -webkit-backface-visibility: visible !important;\n  backface-visibility: visible !important;\n  animation-name: flipInX;\n}\n\n@keyframes flipInY {\n  0% {\n    transform: perspective(400px) rotateY(90deg);\n    animation-timing-function: ease-in;\n    opacity: 0;\n  }\n  40% {\n    transform: perspective(400px) rotateY(-20deg);\n    animation-timing-function: ease-in;\n  }\n  60% {\n    transform: perspective(400px) rotateY(10deg);\n    opacity: 1;\n  }\n  80% {\n    transform: perspective(400px) rotateY(-5deg);\n  }\n  to {\n    transform: perspective(400px);\n  }\n}\n\n.flipInY {\n  -webkit-backface-visibility: visible !important;\n  backface-visibility: visible !important;\n  animation-name: flipInY;\n}\n\n@keyframes flipOutX {\n  0% {\n    transform: perspective(400px);\n  }\n  30% {\n    transform: perspective(400px) rotateX(-20deg);\n    opacity: 1;\n  }\n  to {\n    transform: perspective(400px) rotateX(90deg);\n    opacity: 0;\n  }\n}\n\n.flipOutX {\n  animation-name: flipOutX;\n  -webkit-backface-visibility: visible !important;\n  backface-visibility: visible !important;\n}\n\n@keyframes flipOutY {\n  0% {\n    transform: perspective(400px);\n  }\n  30% {\n    transform: perspective(400px) rotateY(-15deg);\n    opacity: 1;\n  }\n  to {\n    transform: perspective(400px) rotateY(90deg);\n    opacity: 0;\n  }\n}\n\n.flipOutY {\n  -webkit-backface-visibility: visible !important;\n  backface-visibility: visible !important;\n  animation-name: flipOutY;\n}\n\n@keyframes lightSpeedIn {\n  0% {\n    transform: translate3d(100%, 0, 0) skewX(-30deg);\n    opacity: 0;\n  }\n  60% {\n    transform: skewX(20deg);\n    opacity: 1;\n  }\n  80% {\n    transform: skewX(-5deg);\n    opacity: 1;\n  }\n  to {\n    transform: none;\n    opacity: 1;\n  }\n}\n\n.lightSpeedIn {\n  animation-name: lightSpeedIn;\n  animation-timing-function: ease-out;\n}\n\n@keyframes lightSpeedOut {\n  0% {\n    opacity: 1;\n  }\n  to {\n    transform: translate3d(100%, 0, 0) skewX(30deg);\n    opacity: 0;\n  }\n}\n\n.lightSpeedOut {\n  animation-name: lightSpeedOut;\n  animation-timing-function: ease-in;\n}\n\n@keyframes rotateIn {\n  0% {\n    transform-origin: center;\n    transform: rotate(-200deg);\n    opacity: 0;\n  }\n  to {\n    transform-origin: center;\n    transform: none;\n    opacity: 1;\n  }\n}\n\n.rotateIn {\n  animation-name: rotateIn;\n}\n\n@keyframes rotateInDownLeft {\n  0% {\n    transform-origin: left bottom;\n    transform: rotate(-45deg);\n    opacity: 0;\n  }\n  to {\n    transform-origin: left bottom;\n    transform: none;\n    opacity: 1;\n  }\n}\n\n.rotateInDownLeft {\n  animation-name: rotateInDownLeft;\n}\n\n@keyframes rotateInDownRight {\n  0% {\n    transform-origin: right bottom;\n    transform: rotate(45deg);\n    opacity: 0;\n  }\n  to {\n    transform-origin: right bottom;\n    transform: none;\n    opacity: 1;\n  }\n}\n\n.rotateInDownRight {\n  animation-name: rotateInDownRight;\n}\n\n@keyframes rotateInUpLeft {\n  0% {\n    transform-origin: left bottom;\n    transform: rotate(45deg);\n    opacity: 0;\n  }\n  to {\n    transform-origin: left bottom;\n    transform: none;\n    opacity: 1;\n  }\n}\n\n.rotateInUpLeft {\n  animation-name: rotateInUpLeft;\n}\n\n@keyframes rotateInUpRight {\n  0% {\n    transform-origin: right bottom;\n    transform: rotate(-90deg);\n    opacity: 0;\n  }\n  to {\n    transform-origin: right bottom;\n    transform: none;\n    opacity: 1;\n  }\n}\n\n.rotateInUpRight {\n  animation-name: rotateInUpRight;\n}\n\n@keyframes rotateOut {\n  0% {\n    transform-origin: center;\n    opacity: 1;\n  }\n  to {\n    transform-origin: center;\n    transform: rotate(200deg);\n    opacity: 0;\n  }\n}\n\n.rotateOut {\n  animation-name: rotateOut;\n}\n\n@keyframes rotateOutDownLeft {\n  0% {\n    transform-origin: left bottom;\n    opacity: 1;\n  }\n  to {\n    transform-origin: left bottom;\n    transform: rotate(45deg);\n    opacity: 0;\n  }\n}\n\n.rotateOutDownLeft {\n  animation-name: rotateOutDownLeft;\n}\n\n@keyframes rotateOutDownRight {\n  0% {\n    transform-origin: right bottom;\n    opacity: 1;\n  }\n  to {\n    transform-origin: right bottom;\n    transform: rotate(-45deg);\n    opacity: 0;\n  }\n}\n\n.rotateOutDownRight {\n  animation-name: rotateOutDownRight;\n}\n\n@keyframes rotateOutUpLeft {\n  0% {\n    transform-origin: left bottom;\n    opacity: 1;\n  }\n  to {\n    transform-origin: left bottom;\n    transform: rotate(-45deg);\n    opacity: 0;\n  }\n}\n\n.rotateOutUpLeft {\n  animation-name: rotateOutUpLeft;\n}\n\n@keyframes rotateOutUpRight {\n  0% {\n    transform-origin: right bottom;\n    opacity: 1;\n  }\n  to {\n    transform-origin: right bottom;\n    transform: rotate(90deg);\n    opacity: 0;\n  }\n}\n\n.rotateOutUpRight {\n  animation-name: rotateOutUpRight;\n}\n\n@keyframes hinge {\n  0% {\n    transform-origin: top left;\n    animation-timing-function: ease-in-out;\n  }\n  20%, 60% {\n    transform: rotate(80deg);\n    transform-origin: top left;\n    animation-timing-function: ease-in-out;\n  }\n  40%, 80% {\n    transform: rotate(60deg);\n    transform-origin: top left;\n    animation-timing-function: ease-in-out;\n    opacity: 1;\n  }\n  to {\n    transform: translate3d(0, 700px, 0);\n    opacity: 0;\n  }\n}\n\n.hinge {\n  animation-name: hinge;\n}\n\n@keyframes jackInTheBox {\n  0% {\n    opacity: 0;\n    transform: scale(0.1) rotate(30deg);\n    transform-origin: center bottom;\n  }\n  50% {\n    transform: rotate(-10deg);\n  }\n  70% {\n    transform: rotate(3deg);\n  }\n  to {\n    opacity: 1;\n    transform: scale(1);\n  }\n}\n\n.jackInTheBox {\n  animation-name: jackInTheBox;\n}\n\n@keyframes rollIn {\n  0% {\n    opacity: 0;\n    transform: translate3d(-100%, 0, 0) rotate(-120deg);\n  }\n  to {\n    opacity: 1;\n    transform: none;\n  }\n}\n\n.rollIn {\n  animation-name: rollIn;\n}\n\n@keyframes rollOut {\n  0% {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n    transform: translate3d(100%, 0, 0) rotate(120deg);\n  }\n}\n\n.rollOut {\n  animation-name: rollOut;\n}\n\n@keyframes zoomIn {\n  0% {\n    opacity: 0;\n    transform: scale3d(0.3, 0.3, 0.3);\n  }\n  50% {\n    opacity: 1;\n  }\n}\n\n.zoomIn {\n  animation-name: zoomIn;\n}\n\n@keyframes zoomInDown {\n  0% {\n    opacity: 0;\n    transform: scale3d(0.1, 0.1, 0.1) translate3d(0, -1000px, 0);\n    animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  60% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(0, 60px, 0);\n    animation-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1);\n  }\n}\n\n.zoomInDown {\n  animation-name: zoomInDown;\n}\n\n@keyframes zoomInLeft {\n  0% {\n    opacity: 0;\n    transform: scale3d(0.1, 0.1, 0.1) translate3d(-1000px, 0, 0);\n    animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  60% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(10px, 0, 0);\n    animation-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1);\n  }\n}\n\n.zoomInLeft {\n  animation-name: zoomInLeft;\n}\n\n@keyframes zoomInRight {\n  0% {\n    opacity: 0;\n    transform: scale3d(0.1, 0.1, 0.1) translate3d(1000px, 0, 0);\n    animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  60% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(-10px, 0, 0);\n    animation-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1);\n  }\n}\n\n.zoomInRight {\n  animation-name: zoomInRight;\n}\n\n@keyframes zoomInUp {\n  0% {\n    opacity: 0;\n    transform: scale3d(0.1, 0.1, 0.1) translate3d(0, 1000px, 0);\n    animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  60% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(0, -60px, 0);\n    animation-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1);\n  }\n}\n\n.zoomInUp {\n  animation-name: zoomInUp;\n}\n\n@keyframes zoomOut {\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0;\n    transform: scale3d(0.3, 0.3, 0.3);\n  }\n  to {\n    opacity: 0;\n  }\n}\n\n.zoomOut {\n  animation-name: zoomOut;\n}\n\n@keyframes zoomOutDown {\n  40% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(0, -60px, 0);\n    animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  to {\n    opacity: 0;\n    transform: scale3d(0.1, 0.1, 0.1) translate3d(0, 2000px, 0);\n    transform-origin: center bottom;\n    animation-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1);\n  }\n}\n\n.zoomOutDown {\n  animation-name: zoomOutDown;\n}\n\n@keyframes zoomOutLeft {\n  40% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(42px, 0, 0);\n  }\n  to {\n    opacity: 0;\n    transform: scale(0.1) translate3d(-2000px, 0, 0);\n    transform-origin: left center;\n  }\n}\n\n.zoomOutLeft {\n  animation-name: zoomOutLeft;\n}\n\n@keyframes zoomOutRight {\n  40% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(-42px, 0, 0);\n  }\n  to {\n    opacity: 0;\n    transform: scale(0.1) translate3d(2000px, 0, 0);\n    transform-origin: right center;\n  }\n}\n\n.zoomOutRight {\n  animation-name: zoomOutRight;\n}\n\n@keyframes zoomOutUp {\n  40% {\n    opacity: 1;\n    transform: scale3d(0.475, 0.475, 0.475) translate3d(0, 60px, 0);\n    animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  to {\n    opacity: 0;\n    transform: scale3d(0.1, 0.1, 0.1) translate3d(0, -2000px, 0);\n    transform-origin: center bottom;\n    animation-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1);\n  }\n}\n\n.zoomOutUp {\n  animation-name: zoomOutUp;\n}\n\n@keyframes slideInDown {\n  0% {\n    transform: translate3d(0, -100%, 0);\n    visibility: visible;\n  }\n  to {\n    transform: translateZ(0);\n  }\n}\n\n.slideInDown {\n  animation-name: slideInDown;\n}\n\n@keyframes slideInLeft {\n  0% {\n    transform: translate3d(-100%, 0, 0);\n    visibility: visible;\n  }\n  to {\n    transform: translateZ(0);\n  }\n}\n\n.slideInLeft {\n  animation-name: slideInLeft;\n}\n\n@keyframes slideInRight {\n  0% {\n    transform: translate3d(100%, 0, 0);\n    visibility: visible;\n  }\n  to {\n    transform: translateZ(0);\n  }\n}\n\n.slideInRight {\n  animation-name: slideInRight;\n}\n\n@keyframes slideInUp {\n  0% {\n    transform: translate3d(0, 100%, 0);\n    visibility: visible;\n  }\n  to {\n    transform: translateZ(0);\n  }\n}\n\n.slideInUp {\n  animation-name: slideInUp;\n}\n\n@keyframes slideOutDown {\n  0% {\n    transform: translateZ(0);\n  }\n  to {\n    visibility: hidden;\n    transform: translate3d(0, 100%, 0);\n  }\n}\n\n.slideOutDown {\n  animation-name: slideOutDown;\n}\n\n@keyframes slideOutLeft {\n  0% {\n    transform: translateZ(0);\n  }\n  to {\n    visibility: hidden;\n    transform: translate3d(-100%, 0, 0);\n  }\n}\n\n.slideOutLeft {\n  animation-name: slideOutLeft;\n}\n\n@keyframes slideOutRight {\n  0% {\n    transform: translateZ(0);\n  }\n  to {\n    visibility: hidden;\n    transform: translate3d(100%, 0, 0);\n  }\n}\n\n.slideOutRight {\n  animation-name: slideOutRight;\n}\n\n@keyframes slideOutUp {\n  0% {\n    transform: translateZ(0);\n  }\n  to {\n    visibility: hidden;\n    transform: translate3d(0, -100%, 0);\n  }\n}\n\n.slideOutUp {\n  animation-name: slideOutUp;\n}\n\n"},/***** module 38 end *****/


/***** module 39 start *****/
/***** src/pages/testIndex.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".content {\n  flex: 1;\n  display: flex;\n  position: relative;\n  z-index: 10;\n  flex-direction: column;\n  align-items: stretch;\n  justify-content: center;\n  width: 100%;\n  padding-bottom: 250px;\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(244, 244, 244, 0)), color-stop(0.1, #f4f4f4), to(#f4f4f4));\n  opacity: 0;\n  transform: translate3d(0, 100%, 0);\n  animation: rise 3s cubic-bezier(0.19, 1, 0.22, 1) 0.25s forwards;\n}\n\n.hd {\n  position: absolute;\n  top: 0;\n  left: 50%;\n  width: 500px;\n  margin-left: -250px;\n  height: 100px;\n  transition: all 0.35s ease;\n}\n\n.wave {\n  position: absolute;\n  z-index: 3;\n  right: 0;\n  bottom: 0;\n  opacity: 0.725;\n  height: 130px;\n  width: 1125px;\n  animation: wave 10s linear infinite;\n}\n\n.wave-bg {\n  z-index: 1;\n  animation: wave-bg 10.25s linear infinite;\n}\n\n.bd {\n  position: relative;\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  align-items: stretch;\n  animation: bd-rise 2s cubic-bezier(0.23, 1, 0.32, 1) 0.75s forwards;\n  opacity: 0;\n}\n\n.btn {\n  font-size: 14px;\n  line-height: 24px;\n  height: 24px;\n  background: #69c3aa;\n  color: #f4f4f4;\n  text-align: center;\n  border-radius: 50px;\n  margin: 10px;\n}\n\n.card {\n  --from: rgb(255, 210, 0);\n  --to: rgb(247, 151, 30);\n  --shadow: rgba(251, 180, 15, 0.589);\n  position: absolute;\n  top: 100px;\n  width: 80%;\n  height: 130px;\n  color: #fff;\n  background: linear-gradient(130deg, var(--from), var(--to));\n  overflow: hidden;\n  border-radius: 4%/11.5%;\n  box-shadow: 0 53px 67px -26px var(--shadow);\n}\n\n.logo {\n  position: absolute;\n  top: 34%;\n  width: 80px;\n  height: 80px;\n  margin: 0 auto;\n  border-radius: 80px;\n  opacity: 0.95;\n}\n\n"},/***** module 39 end *****/


/***** module 40 start *****/
/***** src/pages/pays.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = ".page-pays {\n  --from: #24C6DC;\n  --stop: #42b9e0;\n  --to: #514A9D;\n  width: 100%;\n  height: 100%;\n  background: -webkit-gradient(linear, left top, left bottom, from(var(--from)), color-stop(0.1, var(--stop)), to(var(--to)));\n}\n\n"},/***** module 40 end *****/


/***** module 41 start *****/
/***** src/pages/swiper.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "swiper {\n  height: 190px;\n  margin-bottom: 10px;\n}\n\nswiper-item,\nswiper-item image {\n  width: 100%;\n  height: 150px;\n  border-radius: 7.5px;\n  overflow: hidden;\n}\n\n.slide-image {\n  position: relative;\n  width: 100%;\n  height: 150px;\n  background: #fff;\n  box-shadow: 0 5px 7.5px rgba(0, 0, 0, 0.1);\n  transition: 0.3s;\n  -webkit-transition: 0.3s;\n}\n\n.swiper-demo .wx-swiper-dot {\n  position: relative;\n  bottom: -8px;\n}\n\n.swiper-demo .wx-swiper-dot-active {\n  background: #69c3aa !important;\n  width: 26px !important;\n  height: 8px !important;\n  border-radius: 10px !important;\n}\n\n"}/***** module 41 end *****/
